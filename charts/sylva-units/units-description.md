...
| **workload-team-defs** | installs the workload-team-defs chart<br/><br/>installs the workload-team-defs chart to install the workload cluster through CRD | experimental |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/workload-team-defs.git) | add-schema |
