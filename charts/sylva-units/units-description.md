...
| :----- | :----- | :----- | :----- |
| **cluster** | holds the Cluster API definition for the cluster | [Helm chart](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | interface-mtu-settings |
| **cluster-bmh** | definitions for Cluster API BareMetalHosts resources (capm3) | [Helm chart](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | interface-mtu-settings |
...
| **vap-prevent-mgmt-cluster-delete** | K8S Validation Admission Policies to prevent deletion of critical resources for mgmt cluster | Kustomization |
