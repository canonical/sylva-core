...
| **kube-logging** | Deploys Fluentbit/Fluentd logging stack from upstream logging-operator chart, for log scraping and shipping |  | [Helm chart](https://github.com/kube-logging/logging-operator.git) | 5.1.1 |
