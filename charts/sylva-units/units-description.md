...
| **crossplane** | Installs Crossplane with RBAC Manager | stable |  | [Helm](https://charts.crossplane.io/stable) | 1.17.1 |
...
| **crossplane-init** | sets up Crossplane prerequisites<br/><br/>it generates CA certificate secret to be used by 'crossplane' unit |  | True | Kustomize | N/A |
