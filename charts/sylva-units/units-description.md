...
| **gitea-postgresql-ha** | installs PostgreSQL HA cluster for Gitea | stable |  | [Helm](https://charts.bitnami.com/bitnami) | 14.2.15 |
| **gitea-redis** | installs Redis cluster for Gitea | stable |  | [Helm](https://charts.bitnami.com/bitnami) | 10.2.9 |
...
| **calico-ready** | ensure Calico resources created by the Tigera operator are ready before running further steps | beta | True | Kustomize | N/A |
