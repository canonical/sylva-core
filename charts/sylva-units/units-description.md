...
| **metrics-server** | rke2-metrics-server install | stable | [Helm chart](https://rke2-charts.rancher.io) | 3.12.200 |
...
| **metrics-server-ha** | rke2-metrics-server ha values | Kustomization |
