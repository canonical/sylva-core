...
| **cabpr** | installs RKE2 CAPI bootstrap provider | core-component |  | [Kustomize](https://github.com/rancher-sandbox/cluster-api-provider-rke2/releases/download/v0.2.5/bootstrap-components.yaml) | v0.2.5 |
...
| **cluster** | holds the Cluster API definition for the cluster | core-component |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | 0.1.47 |
...
| **glauth** | installs glauth | beta | True | Kustomize | N/A |
...
| **metal3-suse** | installs SUSE-maintained Metal3 operator | beta |  | [Helm](https://suse-edge.github.io/charts) | 0.6.1 |
...
| **rancher-users-resources** | configures workload cluster rancher group, users on glauth | beta | True | Helm | N/A |
...
| **rancher-users-resources-inject** | injects Secrets and ConfigMaps generated by rancher-users-resources in glauth projected volumes |  | True | Kustomize | N/A |
