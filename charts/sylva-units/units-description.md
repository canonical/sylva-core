...
| **cluster** | holds the Cluster API definition for the cluster | core-component |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | 0.3.3 |
| **cluster-bmh** | definitions for Cluster API BareMetalHosts resources (capm3) | core-component |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | 0.3.3 |
...
| **gitea-redis** | installs Redis cluster for Gitea | stable |  | [Helm](https://charts.bitnami.com/bitnami) | 11.0.4 |
...
| **keycloak** | initializes and configures Keycloak | stable |  | [Kustomize](https://raw.githubusercontent.com/keycloak/keycloak-k8s-resources/26.0.0/kubernetes/keycloaks.k8s.keycloak.org-v1.yml) | 26.0.0 |
...
| **openshift-monitoring** | Enables monitoring of OKD workload cluster components on Sylva management cluster <br/><br/>Generates a secret for thanos receive authentication for management cluster, configmap to configure Prometheus remoteWrite endpoint to management cluster thanos-receive API. Adds the cluster name as a tag to the metrics sent. | experimental |  | Kustomize | N/A |
| **openshift-user-workload-monitoring** | Enables monitoring of CNF components on workload cluster on Sylva management cluster <br/><br/>Generates a secret for thanos receive authentication for management cluster, configmap to configure Prometheus remoteWrite endpoint to management cluster thanos-receive API. Adds the cluster name as a tag to the metrics sent.<br/>Label the namespace with _*openshift.io/user-monitoring=true*_ for enabling monitoring of the components in that namespace. | experimental |  | Kustomize | N/A |
