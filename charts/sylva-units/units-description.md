...
| **metrics-server** | metrics-server install | stable | [Helm chart](https://rke2-charts.rancher.io) | 3.12.200 |
...
| :----- | :----- | :----- | :----- |
| **cluster** | holds the Cluster API definition for the cluster | [Helm chart](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | rebased-rke2-issue-1857 |
| **cluster-bmh** | definitions for Cluster API BareMetalHosts resources (capm3) | [Helm chart](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-capi-cluster.git) | rebased-rke2-issue-1857 |
...
| **metrics-server-ha** | metrics-server configmap for ha values | Kustomization |
