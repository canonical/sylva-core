...
| **capo-contrail-bgpaas** | installs CAPO Contrail BGPaaS controller | experimental |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/capo-contrail-bgpaas.git) | 1.0.4 |
| **ceph-csi-cephfs** | Installs Ceph-CSI | beta |  | [Helm](https://ceph.github.io/csi-charts) | 3.12.2 |
| **flux-webui** | installs Weave GitOps Flux web GUI | beta |  | [Helm](https://github.com/weaveworks/weave-gitops.git) | v0.38.0 |
| **flux-webui-init** | initializes and configures flux-webui | beta | True | Kustomize | N/A |
| **gitea** | installs Gitea | experimental |  | [Helm](https://dl.gitea.com/charts/) | 10.4.1 |
| **gitea-postgresql-ha** | installs PostgreSQL HA cluster for Gitea | experimental |  | [Helm](https://charts.bitnami.com/bitnami) | 14.2.30 |
| **gitea-redis** | installs Redis cluster for Gitea | experimental |  | [Helm](https://charts.bitnami.com/bitnami) | 11.0.8 |
| **harbor** | installs Harbor | beta |  | [Helm](https://helm.goharbor.io) | 1.15.1 |
| **harbor-postgres** | installs Postgresql for Harbor | beta |  | [Helm](https://charts.bitnami.com/bitnami) | 15.5.36 |
| **kepler** | installs Kepler (Kubernetes-based Efficient Power Level Exporter) exporter for Prometheus | beta |  | [Helm](https://sustainable-computing-io.github.io/kepler-helm-chart) | 0.5.9 |
...
| **sriov-network-operator** | installs SR-IOV operator | beta |  | [Helm](https://suse-edge.github.io/charts/) | 1.3.0 |
