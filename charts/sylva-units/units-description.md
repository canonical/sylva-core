...
| **oauth2-proxy** | installs OAuth2-Proxy for OIDC authentication | stable | [Helm chart](https://oauth2-proxy.github.io/manifests) | 7.8.2 |
...
| **oauth2-init** | initializes and configures oauth2-proxy | Kustomization |
