...
CLUSTER_HOST=$(ubectl -n sylva-system get cluster mgmt-cluster -o jsonpath='{.spec.controlPlaneEndpoint.host}')
CLUSTER_PORT=$(ubectl -n sylva-system get cluster mgmt-cluster -o jsonpath='{.spec.controlPlaneEndpoint.port}')
