...
* `sylva-upgrade-from-1.1.1`: Deploy the management cluster and perform a Sylva upgrade from the 1.1.1 version to main.

* `sylva-upgrade-capm3-from-1.1.1`: Technical scenario. Do NOT use it.
